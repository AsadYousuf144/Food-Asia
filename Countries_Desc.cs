...
{
    public partial class Countries_Desc : Form
    {
        public Countries_Desc()
        {
            InitializeComponent();
        }
       ...
       // SqlConnection con = new SqlConnection(@"Data Source=ASAD-PC;Initial Catalog=March_Events;Persist Security Info=True;User ID=sa;Password=ecg");
        ...
        private void Countries_Desc_Load(object sender, EventArgs e)
        {
            Country();
        }
        ...
        public void Country() {
            ...
            {
                con.Open();
                label2.Text = Countries.abcd;
                
                OleDbCommand command = new OleDbCommand("select distinct Company from Textile1 where Country = '" + Countries.abcd + "';", con);
