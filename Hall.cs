    ...
    public partial class Hall : UserControl
    {
        ...
        public void Halls()
        {
            ...
            try
            {
                ...
                OleDbCommand command = new OleDbCommand("select distinct Hall from Textile1;", con);
                ...
                while (reader.Read())
                {
                   ...
                   // pb6.Image = Image.FromFile(string.Format(@"C:\Users\Asad\Downloads\H.png"));
                    pb6.Image = Properties.Resources.H;
